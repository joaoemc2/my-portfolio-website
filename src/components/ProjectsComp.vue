      ...
      cards: [
        {
          ...
          image: require("@/assets/projectschwarza/schwarza_card_image.webp"),
          update: "[Em andamento]",
        ...
        },
        {
          ...
          image: require("@/assets/donutsapp/donuts_card_image.webp"),
          update: "[Finalizado]",
          link: "/donutsapp",
        },
        {
          ...
          image: require("@/assets/medsim/medsim_card_image.webp"),
          update: "[Em andamento]",
          link: "/medsim",
        },
      ],
